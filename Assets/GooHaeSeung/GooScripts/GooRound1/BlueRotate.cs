...
public class BlueRotate : MonoBehaviour
{
    ...
    //public void SecoundRoundStart()
    //   {
    //       transform.position = Vector3.MoveTowards(transform.position, SecoundRound.transform.position, 7f);
    //   }
}
